...
def multi_resnet101_kd(num_classes=1000):
    return Multi_ResNet(BottleneckBlock, [3,4,23,3], num_classes=num_classes)
def multi_resnet152_kd(num_classes=1000):
    return Multi_ResNet(BottleneckBlock, [3,8,36,3], num_classes=num_classes)
